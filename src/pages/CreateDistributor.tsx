    ...
    <DashboardLayout role={role} walletBalance={walletBalance}>
      <div className="flex flex-col gap-6 max-w-2xl mx-auto py-10">
        ...
        <div className="text-center mb-4">
          <h1 className="text-3xl font-bold mb-2">Create New Distributor</h1>
          <p className="text-muted-foreground">
            Add a new distributor to your network. They’ll receive login credentials via email.
          </p>
        </div>

        {/* Form */}
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 bg-card p-8 rounded-xl shadow-md border border-border">
          ...
          <div className="space-y-2">
            ...
            <Input id="phone" type="tel" placeholder="+91 98765 43210" {...register("phone")} className="h-11" />
